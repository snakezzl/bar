...
original_author="snakezzl"
original_name="bar"
original_urlname="bar"
original_description="Awesome bar created by snakezzl" 
...
then
    ...
    echo "then run 'bar' or 'python -m bar'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'bar' or 'python -m bar' or 'poetry run bar'"
fi
